...
export default class Calculator extends Component {
    ...
    state = {...initialState} //criei um clone e atribui a state
    constructor(props){
        super(props)
...
|| this.state.clearDisplay // regra que nào permite ter mais de um ponto na calculadora e ter mais de um 0

const currentValue = clearDisplay ? '' : this.state.displayValue
const displayValue = currentValue + n //proximo passo é alterar o estado da aplicaçao
